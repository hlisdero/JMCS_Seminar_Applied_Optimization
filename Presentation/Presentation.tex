...
\begin{frame}{argmin}
  ...
  \raggedright
  \tiny Website\footnote{\tiny \url{https://argmin-rs.org/}}
...
\begin{frame}{Advice on ipopt}

  \begin{enumerate}
    \item Not ready for production
    \item For small problems usable
    \item For large problems still not competitive
    \item If people start using it, it will become better
  \end{enumerate}
