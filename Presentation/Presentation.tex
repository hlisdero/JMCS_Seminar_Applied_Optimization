...
\begin{frame}{ripopt: A Rust re-write from February 2026}
  ...
  Coded in $\sim$60/70 hs during 6 weeks with Claude Code\footnote{\url{https://github.com/jkitchin/ripopt}}
  ...
  By who? Prof. John Kitchin, Chemical Engineering at Carnegie Mellon\footnote{\url{https://engineering.cmu.edu/directory/bios/kitchin-john.html}}
  ...
  \begin{itemize}
    ...
    \item Since April 26, separate AI-coded solver by the same author\footnote{\url{https://github.com/jkitchin/feral}}
